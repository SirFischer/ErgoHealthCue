...
public class DataService
{
    ...
    private List<Cue> CreateDefaultCues()
    {
        return new List<Cue>
        {
            ...
            // Standing position exercises - Dynamic movements for circulation and mobility (10 exercises)
            ...
            // Sitting position exercises - Upper body, neck, wrists for desk workers (10 exercises)
            ...
            // Floor position exercises - Deep stretches, hip mobility, splits prep (10 exercises)
