    ...
    private List<Cue> CreateDefaultCues()
    {
        return new List<Cue>
        {
            ...
            new() { Type = CueType.StandingStretch, Title = "Standing Shoulder Rolls", Description = "Roll your shoulders backwards 10 times" },
                ...
                new() { Type = CueType.SittingStretch, Title = "Seated Triceps Stretch", Description = "Reach one arm overhead, bend elbow, use other hand to gently pull, 15 seconds each" },
                new() { Type = CueType.SittingMobilityDrill, Title = "Seated Wrist Circles", Description = "Rotate wrists 10 times in each direction" },
                new() { Type = CueType.SittingMobilityDrill, Title = "Seated Wrist Flexion/Extension", Description = "Flex and extend wrists 15 times, then rotate palms up and down" },
                ...
                new() { Type = CueType.SittingMobilityDrill, Title = "Seated Scapular Squeezes", Description = "Squeeze shoulder blades together, hold 3 seconds, 12 reps" },
