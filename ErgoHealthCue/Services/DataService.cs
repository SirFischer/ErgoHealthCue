...
public class DataService
{
    ...
    private List<Cue> CreateDefaultCues()
    {
        return new List<Cue>
        {
            ...
            new() { Type = CueType.SittingStretch, Title = "Seated Hip Flexor Stretch", Description = "Sit at edge of chair, extend one leg back, press hip forward gently, 15 seconds each side" },
            ...
            new() { Type = CueType.FloorStretch, Title = "Seated Hip Stretch", Description = "Sit with one leg bent in front, other to side, lean forward slightly over front leg, 20 seconds each" },
